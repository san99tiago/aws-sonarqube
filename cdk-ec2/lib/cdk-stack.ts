...
export class CdkSonarQube extends Stack {
  constructor(
    scope: Construct,
    id: string,
    ...
    // Create S3 bucket for added the source code and configurations
    ...
    const _s3DeployFilesConfig = new s3_deploy.BucketDeployment(this, "BucketDeployFilesConfig", {
      sources: [s3_deploy.Source.asset("../config")],
