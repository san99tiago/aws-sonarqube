...
This is a high-level sketch diagram of the deployment's architecture in AWS. <br>

<img src="assets/aws-cdk-sonarqube-ec2.png" width=90%> <br>
...
- [SonarQube Operating the Server (Linux)](https://docs.sonarsource.com/sonarqube/latest/setup-and-upgrade/configure-and-operate-a-server/operating-the-server/)
